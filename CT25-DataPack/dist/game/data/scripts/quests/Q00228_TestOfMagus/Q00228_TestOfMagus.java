			...
			switch (npc.getId())
			{
				...
				case SINGING_FLOWER_PHANTASM:
				{
					if (hasQuestItems(killer, LILAC_CHARM) && !hasQuestItems(killer, GOLDEN_SEED_1ST))
					{
						...
						npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "I am a tree of nothing... a tree... that knows where to return..."));
						playSound(killer, QuestSound.ITEMSOUND_QUEST_MIDDLE);
				...
				case SINGING_FLOWER_NIGTMATE:
				{
					if (hasQuestItems(killer, LILAC_CHARM) && !hasQuestItems(killer, GOLDEN_SEED_2ND))
					{
						...
						npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "I am a creature that shows the truth of the place deep in my heart..."));
						playSound(killer, QuestSound.ITEMSOUND_QUEST_MIDDLE);
				...
				case SINGING_FLOWER_DARKLING:
				{
					if (hasQuestItems(killer, LILAC_CHARM) && !hasQuestItems(killer, GOLDEN_SEED_3RD))
					{
						...
						npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "I am a mirror of darkness... a virtual image of darkness..."));
						playSound(killer, QuestSound.ITEMSOUND_QUEST_MIDDLE);
