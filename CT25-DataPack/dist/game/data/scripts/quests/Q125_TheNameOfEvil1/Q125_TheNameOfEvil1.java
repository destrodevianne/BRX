 ...
 */
package quests.Q125_TheNameOfEvil1;
 ...
 * @author Adry_85
 */
public class Q125_TheNameOfEvil1 extends Quest
{
	// NPCs
	...
	public Q125_TheNameOfEvil1(int questId, String name, String descr)
	{
		...
		questItemIds = new int [] {ORNITHOMIMUS_CLAW, DEINONYCHUS_BONE, EPITAPH_OF_WISDOM, GAZKH_FRAGMENT};
	}
			...
			case MUSHIKA:
				switch (st.getState())
				{
					case State.CREATED:
						...
						{
							st = player.getQuestState(Q124_MeetingTheElroki.class.getSimpleName());
	...
	{
		new Q125_TheNameOfEvil1(125, Q125_TheNameOfEvil1.class.getSimpleName(), "The Name of Evil - 1");
	}
}
