...
import quests.Q125_TheNameOfEvil1.Q125_TheNameOfEvil1;
...
public class Q126_TheNameOfEvil2 extends Quest
{
	...
	public Q126_TheNameOfEvil2(int id, String name, String descr)
	{
		...
		questItemIds = new int[] {GAZKH_FRAGMENT, BONE_POWDER};
	}
			...
			case ASAMAH:
				switch (st.getState())
				{
					case State.CREATED:
						...
						{
							st = player.getQuestState(Q125_TheNameOfEvil1.class.getSimpleName());
	...
	{
		new Q126_TheNameOfEvil2(126, Q126_TheNameOfEvil2.class.getSimpleName(), "The Name of Evil - 2");
	}
}
