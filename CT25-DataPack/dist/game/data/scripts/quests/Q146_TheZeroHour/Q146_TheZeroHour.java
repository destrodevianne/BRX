...
public class Q146_TheZeroHour extends Quest
{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch (st.getState())
		{
			case State.CREATED:
				...
				{
					final QuestState prev = player.getQuestState(Q109_InSearchOfTheNest.class.getSimpleName());
	...
	{
		new Q146_TheZeroHour(146, Q146_TheZeroHour.class.getSimpleName(), "The Zero Hour");
	}
}
