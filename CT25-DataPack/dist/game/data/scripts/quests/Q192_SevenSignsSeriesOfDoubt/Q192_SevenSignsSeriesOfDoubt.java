...
public class Q192_SevenSignsSeriesOfDoubt extends Quest
{
	...
	public Q192_SevenSignsSeriesOfDoubt(int questId, String name, String descr)
	{
		...
		addStartNpc(CROOP);
		addStartNpc(UNIDENTIFIED_BODY);
		addTalkId(CROOP);
		addTalkId(STAN);
		addTalkId(UNIDENTIFIED_BODY);
		addTalkId(HECTOR);
		addTalkId(HOLLINT);
		questItemIds = new int[] {CROOPS_INTRODUCTION, JACOBS_NECKLACE, CROOPS_LETTER};
	}
	...
	{
		new Q192_SevenSignsSeriesOfDoubt(192, Q192_SevenSignsSeriesOfDoubt.class.getSimpleName(), "Seven Signs, Series of Doubt");
	}
}
