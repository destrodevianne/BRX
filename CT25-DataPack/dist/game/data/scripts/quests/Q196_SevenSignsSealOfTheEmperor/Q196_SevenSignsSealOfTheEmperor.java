...
import quests.Q195_SevenSignsSecretRitualOfThePriests.Q195_SevenSignsSecretRitualOfThePriests;
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch (npc.getNpcId())
		{
			case HEINE:
				...
				QuestState qs = player.getQuestState(Q195_SevenSignsSecretRitualOfThePriests.class.getSimpleName());
				if(qs == null)
				return htmltext;
