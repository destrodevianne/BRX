 ...
 */
package quests.Q197_SevenSignsTheSacredBookOfSeal;
 ...
 * @author Adry_85
 */
public class Q197_SevenSignsTheSacredBookOfSeal extends Quest
{
	// NPCs
	...
	public Q197_SevenSignsTheSacredBookOfSeal(int questId, String name, String descr)
	{
		...
		questItemIds = new int[] {MYSTERIOUS_HAND_WRITTEN_TEXT, SCULPTURE_OF_DOUBT};
	}
	...
	{
		new Q197_SevenSignsTheSacredBookOfSeal(197, Q197_SevenSignsTheSacredBookOfSeal.class.getSimpleName(), "Seven Signs, the Sacred Book of Seal");
	}
}
