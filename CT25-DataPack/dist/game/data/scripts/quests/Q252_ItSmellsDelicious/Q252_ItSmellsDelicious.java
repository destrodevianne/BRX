...
public class Q252_ItSmellsDelicious extends Quest
{
	...
	public Q252_ItSmellsDelicious(int id, String name, String descr)
	{
		...
		questItemIds = new int[] {MAHUM_DIARY, MAHUM_COOKBOOK};
	}
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		else if (npcId == CHEF)
		{
			...
			if ((st != null) && st.isStarted() && (st.isCond(1)) && (st.getQuestItemsCount(MAHUM_COOKBOOK) < 5) && (Rnd.get(1000) < 360))
			{
	...
	{
		new Q252_ItSmellsDelicious(252, Q252_ItSmellsDelicious.class.getSimpleName(), "It Smells Delicious!");
	}
}
