...
public class Q461_RumbleInTheBase extends Quest
{
	...
	public Q461_RumbleInTheBase(int questId, String name, String descr)
	{
		...
		questItemIds = new int[] {SHINY_SALMON, SHOES_STRING_OF_SEL_MAHUM};
	}
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		final QuestState prev = player.getQuestState(Q252_ItSmellsDelicious.class.getSimpleName());
		switch (st.getState())
		{
			case State.CREATED:
	...
	{
		new Q461_RumbleInTheBase(461, Q461_RumbleInTheBase.class.getSimpleName(), "Rumble in the Base");
	}
}
