 ...
 */
package quests.Q701_ProofOfExistence;
 ...
 * @author malyelfik
 */
public class Q701_ProofOfExistence extends Quest
{
	// NPC
	...
	private Q701_ProofOfExistence(int questId, String name, String descr)
	{
		...
		for (int id : MOBS.keySet())
			super.addKillId(id);
		addKillId(ENIRA);
		questItemIds = new int[] {DEADMANS_REMAINS, BANSHEE_QUEENS_EYE};
	}
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		else if (Rnd.get(1000) < MOBS.get(npc.getNpcId()))
		{
	...
	{
		new Q701_ProofOfExistence(701, Q701_ProofOfExistence.class.getSimpleName(), "Proof of Existence");
	}
}