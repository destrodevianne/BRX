...
public class Q702_ATrapForRevenge extends Quest
{
	...
	public Q702_ATrapForRevenge(int questId, String name, String descr)
	{
		...
		questItemIds = new int[] {DRAKES_FLESH, ROTTEN_BLOOD, BAIT_FOR_DRAKES, VARIANT_DRAKE_WING_HORNS};
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("32555-15.html"))
		{
			...
			if ((i0 >= 500) && (i1 >= 600))
			{
				st.giveAdena(Rnd.get(49917) + 125000, false);
				if (i1 < 720)
				{
			...
			{
				st.giveAdena(Rnd.get(49917) + 25000, false);
				if (i1 < 720)
				{
					st.giveItems(9628, Rnd.get(3) + 1);
					st.giveItems(9629, Rnd.get(3) + 1);
	...
	{
		new Q702_ATrapForRevenge(702, Q702_ATrapForRevenge.class.getSimpleName(), "A Trap for Revenge");
	}
}
