				...
				case RAGNA_ORC_SEER:
				{
					switch (npc.getScriptValue())
					{
						case 0:
						{
							...
							{
								npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "Is it a lackey of Kakai?!"));
				...
				case REVENANT_OF_TANTOS_CHIEF:
				{
					switch (npc.getScriptValue())
					{
						case 0:
						{
							...
							if (!hasQuestItems(attacker, SCEPTER_OF_TANTOS))
							{
								npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "How regretful! Unjust dishonor!"));
								npc.setScriptValue(1);
							}
							break;
						}
						case 1:
						{
							...
							{
								npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "Indignant and unfair death!"));
								npc.setScriptValue(2);
							}
							break;
						}
			...
			switch (npc.getId())
			{
				...
				case REVENANT_OF_TANTOS_CHIEF:
				{
					if (hasQuestItems(killer, TANAPIS_ORDER) && !hasQuestItems(killer, SCEPTER_OF_TANTOS))
					{
						...
						npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "I'll get revenge someday!!"));
						qs.setCond(10, true);
					}
					break;
				}
