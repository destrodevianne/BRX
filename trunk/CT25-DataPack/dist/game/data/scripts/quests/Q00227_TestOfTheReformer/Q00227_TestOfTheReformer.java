		...
		if ((qs != null) && qs.isStarted())
		{
			switch (npc.getId())
			{
				...
				case CRIMSON_WEREWOLF:
				{
					...
					{
						npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "Cowardly guy!"));
						npc.deleteMe();
					}
		...
		if ((qs != null) && qs.isStarted() && Util.checkIfInRange(1500, npc, killer, true))
		{
			switch (npc.getId())
			{
				...
				case ARURAUNE:
				{
					...
					{
						npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "The concealed truth will always be revealed...!"));
