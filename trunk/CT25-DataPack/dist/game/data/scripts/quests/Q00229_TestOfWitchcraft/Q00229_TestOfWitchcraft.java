			...
			switch (npc.getId())
			{
				case NAMELESS_REVENANT:
				{
					if (npc.isScriptValue(0) && hasQuestItems(attacker, ALEXANDRIAS_BOOK, LARAS_MEMO) && !hasQuestItems(attacker, AKLANTOTH_3RD_GEM))
					{
						...
						npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "I absolutely cannot give it to you! It is my precious jewel!"));
					}
					break;
				}
				...
				case DREVANUL_PRINCE_ZERUEL:
				{
					...
					{
						npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "I'll take your lives later!"));
						npc.deleteMe();
						qs.setCond(5, true);
					}
					else if (hasQuestItems(attacker, ORIMS_INSTRUCTIONS, BRIMSTONE_2ND, SWORD_OF_BINDING, SOULTRAP_CRYSTAL))
					{
						...
						{
							npc.setScriptValue(1);
							npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "That sword is really...!"));
						}
					}
					break;
				}
			...
			switch (npc.getId())
			{
				...
				case DREVANUL_PRINCE_ZERUEL:
				{
					if (hasQuestItems(killer, ORIMS_INSTRUCTIONS, BRIMSTONE_2ND, SWORD_OF_BINDING, SOULTRAP_CRYSTAL))
					{
						...
						{
							npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "No! I haven't completely finished the command for destruction and slaughter yet!!!"));
