...
public class Q109_InSearchOfTheNest extends Quest
{
	...
	private Q109_InSearchOfTheNest(int id, String name, String descr)
	{
		super(id, name, descr);
		addStartNpc(PIERCE);
		addTalkId(PIERCE);
		addTalkId(SCOUTS_CORPSE);
		addTalkId(KAHMAN);
		questItemIds = new int[] {SCOUTS_NOTE};
	}
	...
	{
		new Q109_InSearchOfTheNest(109, Q109_InSearchOfTheNest.class.getSimpleName(), "In Search of the Nest");
	}
}
