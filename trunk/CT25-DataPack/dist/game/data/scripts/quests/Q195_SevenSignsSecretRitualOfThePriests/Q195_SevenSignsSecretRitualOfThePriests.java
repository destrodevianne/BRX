 ...
 */
package quests.Q195_SevenSignsSecretRitualOfThePriests;

import java.util.ArrayList;
import java.util.Collection;

import quests.Q194_SevenSignsMammonsContract.Q194_SevenSignsMammonsContract;
...
public class Q195_SevenSignsSecretRitualOfThePriests extends Quest
{
	...
	public Q195_SevenSignsSecretRitualOfThePriests(int questId, String name, String descr)
	{
		...
		switch (st.getState())
		{
			...
			case State.CREATED:
		        	if (npcId == CLAUDIA_ATHEBALDT)
		        	{
		            		...
		            		{
						final QuestState qs = st.getPlayer().getQuestState(Q194_SevenSignsMammonsContract.class.getSimpleName());
						if (qs != null)
						{
							if (qs.isCompleted())
	...
	{
		new Q195_SevenSignsSecretRitualOfThePriests(195, Q195_SevenSignsSecretRitualOfThePriests.class.getSimpleName(), "Seven Signs, Secret Ritual Of The Priests");
	}
}
