...
import quests.Q251_NoSecrets.Q251_NoSecrets;
...
public class Q290_ThreatRemoval extends Quest
{
	...
	public Q290_ThreatRemoval(int questId, String name, String descr)
	{
		super(questId, name, descr);
		addStartNpc(PINAPS);
		addTalkId(PINAPS);
		
		for (int id : MOBS_TAG.keySet())
			super.addKillId(id);
		
		questItemIds = new int [] {SEL_MAHUM_ID_TAG};
	}
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch (st.getState())
		{
			case State.CREATED:
			{
				st = player.getQuestState(Q251_NoSecrets.class.getSimpleName());
	...
	{
		new Q290_ThreatRemoval(290, Q290_ThreatRemoval.class.getSimpleName(), "Threat Removal");
	}
}
