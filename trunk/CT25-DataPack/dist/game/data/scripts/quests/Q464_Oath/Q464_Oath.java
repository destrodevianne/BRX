 ...
 * @author malyelfik
 */
public class Q464_Oath extends Quest
{
	// NPCs @formatter:off
	...
	public Q464_Oath(int questId, String name, String descr)
	{
		...
		questItemIds = new int[] {BOOK, BOOK2};
	}
	...
	{
		new Q464_Oath(464, Q464_Oath.class.getSimpleName(), "Oath");
	}
}