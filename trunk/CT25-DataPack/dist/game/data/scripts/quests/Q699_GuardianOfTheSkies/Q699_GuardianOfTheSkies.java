 ...
 */
package quests.Q699_GuardianOfTheSkies;
 ...
 * @author xban1x
 */
public class Q699_GuardianOfTheSkies extends Quest
{
	// NPC
	...
	public Q699_GuardianOfTheSkies(int questId, String name, String descr)
	{
		...
		for (int id : MONSTERS.keySet())
			super.addKillId(id);
		questItemIds = new int[] {VULTURES_GOLDEN_FEATHER};
	}
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		...
		if (st != null)
		{
			if (npc.getNpcId() == VALDSTONE)
			{
				...
				if (chance < 215)
				{
					amount = Rnd.get(10) + 90;
				}
				else if (chance < 446)
				{
					amount = Rnd.get(10) + 80;
				}
				else if (chance < 715)
				{
					amount = Rnd.get(10) + 70;
				}
				else
				{
					amount = Rnd.get(10) + 60;
				}
			...
			{
				if (Rnd.get(1000) < MONSTERS.get(npc.getNpcId()))
				{
	...
	{
		new Q699_GuardianOfTheSkies(699, Q699_GuardianOfTheSkies.class.getSimpleName(), "Guardian of the Skies");
	}
}
