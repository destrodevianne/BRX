...
extends L2ObjectMap<T>
{
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.util.L2ObjectMap#size()
	 */
	@Override
	public int size()
	{
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.util.L2ObjectMap#isEmpty()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.util.L2ObjectMap#clear()
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.util.L2ObjectMap#put(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.util.L2ObjectMap#remove(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.util.L2ObjectMap#get(int)
	 */
	@Override
	public T get(int id)
	{
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.util.L2ObjectMap#contains(T)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.util.L2ObjectMap#iterator()
	 */
	@Override
